...
func (l *RegisterLogic) Register(req *types.RegisterReq) (resp *types.RegisterResp, err error) {
	...
	if err := userutils.VerifyEmailAndCodeInRedis(l.ctx, l.svcCtx.Redis, req.Email, req.Code, codeType); err != nil {
		l.svcCtx.Metrics.UserRegistrationsTotal.Inc(metrics.UserRegistrationsTotalSourceWeb, metrics.UserRegistrationsTotalStatusFailed)
		return nil, err
	}
	...
	// 密码加密
	hashedPassword, err := userutils.HashPassword(l.ctx, req.Email, req.Password, l.svcCtx.Config.BcryptCost)
	if err != nil {
		l.svcCtx.Metrics.UserRegistrationsTotal.Inc(metrics.UserRegistrationsTotalSourceWeb, metrics.UserRegistrationsTotalStatusFailed)
		return nil, err
	}
	...
	l.svcCtx.Metrics.UserRegistrationsTotal.Inc(metrics.UserRegistrationsTotalSourceWeb, metrics.UserRegistrationsTotalStatusSuccess)
	return
}
